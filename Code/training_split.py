...
from configuration import training_sample_list_filename, validation_sample_list_filename, \
    percent_images_before_peak_for_training, training_images_list_filename, validation_images_list_filename
from sklearn.model_selection import train_test_split

# %% merge the given sequence labels and our manual sequence labels into a single csv
# for Matt: - os.chdir(r'/home/ubuntu/Desktop-Sync-Folder/Final-Project-Group10/Code')
