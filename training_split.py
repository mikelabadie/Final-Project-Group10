...
from project_configuration import training_sample_list_filename, validation_sample_list_filename, \
...
df2 = pd.read_csv("sequences_missing_labels_completed.csv")
...
images_all = pd.read_csv("images_all.csv")
